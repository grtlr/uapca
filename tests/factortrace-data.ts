...
import {Distribution, MultivariateNormal, Point, TracePoint} from '../src/index';

export class StudentExample {
    public readonly distributions: Array<Distribution> = [];
    ...
    public constructor() {
        ...
        this.distributions.push(new MultivariateNormal(
            new Matrix([[15], [12.285714285714285], [14.095238095238097], [15]]),
            new Matrix([
                [0.1, 0, 0, 0],
        ...
        this.distributions.push(new MultivariateNormal(
            new Matrix([[9], [15.285714285714285], [12.285714285714285], [10]]),
            new Matrix([
                [0.1, 0, 0, 0],
                [0, 1.227891156462585, 0, 0],
        ...
        this.distributions.push(new MultivariateNormal(
            new Matrix([[6], [10.5], [16.5], [15.285714285714285]]),
            new Matrix([
                [0.1, 0, 0, 0],
        ...
        this.distributions.push(new MultivariateNormal(
            new Matrix([[12.285714285714285], [17.83333315778618], [19], [11]]),
            new Matrix([
                [1.227891156462585, 0, 0, 0],
        ...
        this.distributions.push(new MultivariateNormal(
            new Matrix([[2.16666669375], [7.7142857142857135], [12], [14]]),
            new Matrix([
                [1.9722221881944448, 0, 0, 0],
                [0, 1.227891156462585, 0, 0],
        ...
        this.expected2dTracePoints.push({
            ...
            projectedUnitVectors: [
                new Point([0.7008923218383587, 0.0060086685798348945]),
        ...
        this.expected2dTracePoints.push({
            scale: 0.1,
            projectedUnitVectors: [
                new Point([0.7007091290604303, 0.007938540933201661]),
        ...
        this.expected2dTracePoints.push({
            scale: 0.4,
            projectedUnitVectors: [
                new Point([0.6979056457045778, 0.04228641382084042]),
        ...
        this.expected2dTracePoints.push({
            scale: 0.9,
            projectedUnitVectors: [
                new Point([0.6844442626793106, 0.3006065902573376]),
        ...
        this.expected2dTracePoints.push({
            scale: 1.6,
            projectedUnitVectors: [
                new Point([0.6346016439294941, 0.4580233794232739]),
        ...
        this.expected2dTracePoints.push({
            scale: 2.5,
            projectedUnitVectors: [
                new Point([0.4531385020572791, 0.6068745698045509]),
        ...
        this.expected2dTracePoints.push({
            scale: 3.6,
            projectedUnitVectors: [
                new Point([0.19843355422684578, 0.6982904942112681]),
        ...
        this.expected2dTracePoints.push({
            scale: 4.9,
            projectedUnitVectors: [
                new Point([0.08966054817377281, 0.6724052139934641]),
        ...
        this.expected2dTracePoints.push({
            scale: 6.4,
            projectedUnitVectors: [
                new Point([0.04755062325949049, 0.602849952541657]),
        ...
        this.expected2dTracePoints.push({
            scale: 8.1,
            projectedUnitVectors: [
                new Point([0.028107350062858097, 0.5025279837731735]),
        ...
        this.expected2dTracePoints.push({
            scale: 10,
            projectedUnitVectors: [
                new Point([0.01787163222229783, 0.3893981889434975]),
        ...
        this.expected2dTracePoints.push({
            scale: 12.1,
            projectedUnitVectors: [
                new Point([0.01197698468671412, 0.28771235662246714]),
        ...
        this.expected2dTracePoints.push({
            scale: 14.4,
            projectedUnitVectors: [
                new Point([0.008355493295764217, 0.20946821418770428]),
        ...
        this.expected2dTracePoints.push({
            scale: 16.9,
            projectedUnitVectors: [
                new Point([0.006018509438167872, 0.15347405449294968]),
        ...
        this.expected2dTracePoints.push({
            scale: 19.6,
            projectedUnitVectors: [
                new Point([0.004450575399762133, 0.11417269383203757]),
        ...
        this.expected2dTracePoints.push({
            scale: 22.5,
            projectedUnitVectors: [
                new Point([0.0033645922946557204, 0.08643578226831716]),
        ...
        this.expected2dTracePoints.push({
            scale: 25.6,
            projectedUnitVectors: [
                new Point([0.0025920913885672378, 0.06656499140761375]),
        ...
        this.expected2dTracePoints.push({
            scale: 28.9,
            projectedUnitVectors: [
                new Point([0.0020299313422870975, 0.05207632066001293]),
        ...
        this.expected2dTracePoints.push({
            scale: 32.4,
            projectedUnitVectors: [
                new Point([0.001612692937266601, 0.041325203337994505]),
        ...
        this.expected2dTracePoints.push({
            scale: 36.1,
            projectedUnitVectors: [
                new Point([0.001297616484658438, 0.03321537044392426]),
